...
#define PMIX_INSTALL_PREFIX "/users/jarbas/rpmbuild/BUILD"
#define PMIX_EXEC_PREFIX "/usr"

/* The directory for installing executable programs that users can
   run. */
#define PMIX_BINDIR "/usr/bin"

/* The directory for installing executable programs that can be run
   from the shell, but are only generally useful to system
   administrators. */
#define PMIX_SBINDIR "/usr/sbin"
...
#define PMIX_LIBEXECDIR "/usr/libexec"
...
#define PMIX_SYSCONFDIR "/etc"

/* The directory for installing architecture-independent data files
   which the programs modify while they run. */
#define PMIX_SHAREDSTATEDIR "/var/lib"
...
#define PMIX_INCLUDEDIR "/usr/include"
...
#define PMIX_INFODIR "/usr/share/info"

/* The top-level directory for installing the man pages (if any) for
   this package. */
#define PMIX_MANDIR "/usr/share/man"
