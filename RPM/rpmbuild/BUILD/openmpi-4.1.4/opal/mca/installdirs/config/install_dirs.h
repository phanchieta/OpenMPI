...
#define OPAL_PREFIX "/users/jarbas/rpmbuild/BUILD"
#define OPAL_EXEC_PREFIX "/usr"

/* The directory for installing executable programs that users can
   run. */
#define OPAL_BINDIR "/usr/bin"

/* The directory for installing executable programs that can be run
   from the shell, but are only generally useful to system
   administrators. */
#define OPAL_SBINDIR "/usr/sbin"
...
#define OPAL_LIBEXECDIR "/usr/libexec"
...
#define OPAL_SYSCONFDIR "/etc"

/* The directory for installing architecture-independent data files
   which the programs modify while they run. */
#define OPAL_SHAREDSTATEDIR "/var/lib"
...
#define OPAL_INCLUDEDIR "/usr/include"
...
#define OPAL_INFODIR "/usr/share/info"

/* The top-level directory for installing the man pages (if any) for
   this package. */
#define OPAL_MANDIR "/usr/share/man"
