...
/* Define to 1 if you have the declaration of `ucp_ep_flush_nbx', and to 0 if
   you don't. */
#define HAVE_DECL_UCP_EP_FLUSH_NBX 1
...
/* Define to 1 if you have the declaration of `UCP_OP_ATTR_FLAG_MULTI_SEND',
   and to 0 if you don't. */
#define HAVE_DECL_UCP_OP_ATTR_FLAG_MULTI_SEND 1
...
#define HAVE_DECL_UCP_WORKER_FLAG_IGNORE_REQUEST_LEAK 1
...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-DNDEBUG -O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector-strong --param=ssp-buffer-size=4 -grecord-gcc-switches -m64 -mtune=generic -finline-functions -fno-strict-aliasing -mcx16 -pthread -D__EXTENSIONS__' CPPFLAGS='-I/home/jarbas/rpmbuild/BUILD/openmpi-4.1.4/opal/mca/event/libevent2022/libevent -I/home/jarbas/rpmbuild/BUILD/openmpi-4.1.4/opal/mca/event/libevent2022/libevent/include -I/home/jarbas/rpmbuild/BUILD/openmpi-4.1.4/opal/mca/hwloc/hwloc201/hwloc/include   -I/usr/local/include -I/usr/local/include' FFLAGS='-O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector-strong --param=ssp-buffer-size=4 -grecord-gcc-switches   -m64 -mtune=generic -I/usr/lib64/gfortran/modules' LDFLAGS='-Wl,-z,relro  ' --enable-shared --disable-static  --prefix=/users/jarbas/rpmbuild/BUILD --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OMPI_RELEASE_DATE "May 26, 2022"
...
#define OMPI_TARBALL_VERSION "4.1.4"
...
#define OPAL_ARCH "x86_64-redhat-linux-gnu"
...
/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION_STR 8.3.1
...
#define OPAL_ENABLE_DYNAMIC_SL 1
...
#define OPAL_IDENT_STRING "4.1.4"
...
#define OPAL_PACKAGE_STRING "Open MPI jarbas@localhost.localdomain Distribution"
...
#define OPAL_RELEASE_DATE "May 26, 2022"
...
#define OPAL_TARBALL_VERSION "4.1.4"
...
#define ORTE_RELEASE_DATE "May 26, 2022"
...
#define OSHMEM_RELEASE_DATE "May 26, 2022"
...
#define OSHMEM_TARBALL_VERSION "4.1.4"
...
#define PACKAGE_STRING "Open MPI 4.1.4"
